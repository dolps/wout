...
import { WorkOutDialogComponent } from '../../../../../../main/webapp/app/entities/work-out/work-out-dialog.component';
...
describe('Component Tests', () => {
    ...
    describe('WorkOut Management Dialog Component', () => {
        let comp: WorkOutDialogComponent;
        ...
        beforeEach(async(() => {
            ...
            .overrideTemplate(WorkOutDialogComponent, '')
            .compileComponents();
        }));
            ...
            it('Should call update service on save for existing entity',
                inject([],
                    fakeAsync(() => {
                        ...
                        expect(mockEventManager.broadcastSpy).toHaveBeenCalledWith({ name: 'workOutListModification', content: 'OK'});
